...
public class ReplacedFoxhoundModel<T extends ReplacedFoxhound<Foxhound>> extends ReplacedQuatrupleModel<T> {
    ...
    public ResourceLocation getModelResource(T object) {
        return new ResourceLocation(CombatIntegration.MODID, "geo/qrk/foxhound.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(T animatable) {
        return new ResourceLocation(CombatIntegration.MODID,"animations/qrk/foxhound.animation.json");
    }
