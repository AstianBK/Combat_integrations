...
import com.TBK.combat_integration.client.models.compi.dm.ReplacedZombiefierFungusThrowerModel;
...
public class ReplacedZombiefierFungusThrowerRenderer<T extends ZombifiedFungusThrowerEntity,P extends ReplacedZombieFungusThrower<T>> extends ExtendedGeoReplacedEntityRenderer<T,P> {
    public ReplacedZombiefierFungusThrowerRenderer(EntityRendererProvider.Context renderManager){
        ...
        this.addLayer(new ArmorGeckoLayer<>(this,getGeoModelProvider(),new ResourceLocation(DungeonsMobs.MODID,"textures/entity/piglin/zombified_fungus_thrower.png"),new ResourceLocation(CombatIntegration.MODID,"geo/piglin.geo.json")){
            @NotNull
            @Override
