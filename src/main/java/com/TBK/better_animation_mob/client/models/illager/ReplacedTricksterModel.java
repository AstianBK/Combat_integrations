...
public class ReplacedTricksterModel<T extends IAnimatable> extends ReplacedVindicatorModel<T> {
    ...
    public ResourceLocation getModelResource(T object) {
        return new ResourceLocation(BetterAnimationMob.MODID, "geo/svr/svrtrickster.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(T animatable) {
        return new ResourceLocation(BetterAnimationMob.MODID,"animations/svr/svrtrickster.animation.json");
    }
