...
public class ReplacedRavagerModel <T extends IAnimatable> extends ReplacedQuatrupleModel<T> {
    ...
    public ResourceLocation getModelResource(T object) {
        return new ResourceLocation(BetterAnimationMob.MODID, "geo/ravager.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(T animatable) {
        return new ResourceLocation(BetterAnimationMob.MODID,"animations/ravager.animation.json");
    }
