...
public class ReplacedStrayRenderer<T extends AbstractSkeleton,P extends ReplacedSkeleton> extends ReplacedSkeletonRenderer<T,P> {
    public ReplacedStrayRenderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addLayer(new StrayGeckoLayer<>(this,this.getGeoModelProvider(),new ResourceLocation("textures/entity/skeleton/stray.png"),new ResourceLocation(BetterAnimationMob.MODID,"geo/skeleton.geo.json"),new ResourceLocation("textures/entity/skeleton/stray_overlay.png")));
    }
}
